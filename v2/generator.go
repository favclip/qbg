...
func Parse(pkg *genbase.PackageInfo, typeInfos genbase.TypeInfos) (*BuildSource, error) {
	...
	bu.g.AddImport("google.golang.org/appengine/v2/datastore", "")
	bu.g.AddImport("github.com/favclip/qbg/v2/qbgutils", "")
...
func (b *BuildSource) Parse(pkg *genbase.PackageInfo, typeInfos genbase.TypeInfos) error {
	...
	if b.UseDatastoreWrapper {
		b.g.AddImport("go.mercari.io/datastore/v2", "")
	} else {
		b.g.AddImport("google.golang.org/appengine/v2/datastore", "")
	}
	if !b.InlineInterfaces {
		b.g.AddImport("github.com/favclip/qbg/v2/qbgutils", "")
	}
