...
var (
	...
	useDatastoreWrapper = flag.Bool("usedatastorewrapper", false, "use go.mercari.io/datastore/v2")
)
...
func main() {
	...
	if bu.UseDatastoreWrapper {
		// go.mercari.io/datastore/v2 can't use qbgutils
